							...
							<li {...getOptionProps({option, index})}>
								<div>
									<Grid container>
										...
										<Grid item xs={4}>
											<Typography variant={"subtitle1"}> This is the very long text that has been here for a while.
												Since the year of {option.year} this was looooooo oooooo oooooong time ago.</Typography>
										</Grid>
									</Grid>
								</div>
							</li>
